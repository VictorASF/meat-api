...
class ModelRouter extends router_1.Router {
    constructor(model) {
        ...
        this.replace = (req, resp, next) => {
            this.model.update({ _id: req.params.id }, req.body, { override: true, runValidators: true })
                .exec().then(result => {
                if (result.n) {
        ...
        this.update = (req, resp, next) => {
            ...
            this.model.findByIdAndUpdate(req.params.id, req.body, options).then(this.render(resp, next))
                .catch(next);
        };
